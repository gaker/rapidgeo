...
fn main() {
    ...
    for i in 0..5000 {  // Reduced for demo
    ...
    println!("serial path: {:.0} km in {:?}", serial_total / 1000.0, serial_time);
    ...
    println!("simulated parallel: {:.0} km in {:?}", simulated_parallel_total / 1000.0, simulated_parallel_time);
