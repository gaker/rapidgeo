use map_distance::{
    LngLat,
    geodesic::{point_to_segment_enu_m, great_circle_point_to_seg},
...
fn main() {
    ...
    println!("  great circle: {:.0} m", great_circle_point_to_seg(fresno, segment));
    println!("  euclidean: {:.6} deg", point_to_segment(fresno, segment));
    println!("  euclidean²: {:.6} deg²", point_to_segment_squared(fresno, segment));
    ...
    println!("  enu: {:.0} m", point_to_segment_enu_m(above, horizontal_segment));
    println!("  euclidean: {:.3} deg", point_to_segment(above, horizontal_segment));
